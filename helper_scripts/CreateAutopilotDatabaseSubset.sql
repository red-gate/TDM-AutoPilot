...
GO
PRINT N'Creating primary key [PK__Customer__A4AE64B82844B378] on [Customers].[Customer]'
GO
...
GO
PRINT N'Creating primary key [PK__Customer__6A4BEDF68036D519] on [Customers].[CustomerFeedback]'
GO
...
GO
PRINT N'Creating primary key [PK__Flight__8A9E148E383D4570] on [Inventory].[Flight]'
GO
...
GO
PRINT N'Creating primary key [PK__Maintena__5E5499A8F6C3B0CE] on [Inventory].[MaintenanceLog]'
GO
...
GO
PRINT N'Creating primary key [PK__Orders__C3905BAFE1FFA45A] on [Sales].[Orders]'
GO
...
GO
PRINT N'Creating primary key [PK__OrderAud__A17F23B8FB6804BC] on [Sales].[OrderAuditLog]'
GO
...
GO
PRINT N'Creating primary key [PK__Discount__E43F6DF6B9A0A692] on [Sales].[DiscountCode]'
GO
...
GO
PRINT N'Creating primary key [PK__LoyaltyP__75256038DF62DDBE] on [Customers].[LoyaltyProgram]'
GO
...
GO
PRINT N'Creating primary key [PK__FlightRo__80979AADBAB65128] on [Inventory].[FlightRoute]'
GO
...
SET IDENTITY_INSERT [Sales].[OrderAuditLog] OFF
