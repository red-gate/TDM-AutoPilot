...
GO
ALTER TABLE [Logistics].[EmployeeTerritories] WITH NOCHECK  ADD CONSTRAINT [FK_EmployeeTerritories_Employees] FOREIGN KEY ([EmployeeID]) REFERENCES [Operation].[Employees] ([EmployeeID])
GO
ALTER TABLE [Logistics].[EmployeeTerritories] WITH NOCHECK  ADD CONSTRAINT [FK_EmployeeTerritories_Territories] FOREIGN KEY ([TerritoryID]) REFERENCES [Sales].[Territories] ([TerritoryID])
GO
...
GO
ALTER TABLE [Sales].[CustomersFeedback] WITH NOCHECK  ADD CONSTRAINT [FK__Customers__Custo__286302EC] FOREIGN KEY ([CustomerID]) REFERENCES [Sales].[Customers] ([CustomerID])
GO
...
GO
ALTER TABLE [Sales].[OrderAuditLog] WITH NOCHECK  ADD CONSTRAINT [FK__OrderAudi__Order__4316F928] FOREIGN KEY ([OrderID]) REFERENCES [Sales].[Orders] ([OrderID])
GO
...
GO
ALTER TABLE [Sales].[Territories] WITH NOCHECK  ADD CONSTRAINT [FK_Territories_Region] FOREIGN KEY ([RegionID]) REFERENCES [Logistics].[Region] ([RegionID])
GO
